      ...
      document.querySelectorAll(".edit-btn").forEach(btn => {
        btn.addEventListener("click", (e: any) => {
          ...
          if (editorContainer && editorContainer.innerHTML.trim() !== "") {
            ...
            document.querySelectorAll('[id^="editor-"]').forEach(e => { if (e !== editorContainer) e.innerHTML = ""; });
      ...
      document.querySelectorAll(".delete-btn").forEach(btn => {
        btn.addEventListener("click", (e: any) => {
          ...
          if (deleteContainer && deleteContainer.innerHTML.trim() !== "") {
            ...
            document.querySelectorAll('[id^="delete-"]').forEach(e => { if (e !== deleteContainer) e.innerHTML = ""; });
...
function renderServiceForm() {
  ...
  document.getElementById("save-service-button")?.addEventListener("click", (e) => {
    e.preventDefault();
  ...
  document.getElementById("cancel-service-button")?.addEventListener("click", (e) => {
    e.preventDefault();
    editorContainer.innerHTML = "";
  });
}
  ...
  loadServices().then(services => {
    ...
    editorContainer.innerHTML = `
      <div class="editor-block animated-fadein">
        ...
        <textarea id="edit-description-${id}" class="input-lg">${service.description ?? ""}</textarea><br>
...
export function renderServiceDetail(serviceId: number, container: HTMLElement) {
  container.innerHTML = `
...
function renderServiceDetailPanel(serviceId: number, container: HTMLElement) {
  loadServices().then(services => {
    ...
    const toggleBtn = container.querySelector("#toggle-entity-types") as HTMLButtonElement;
    if (toggleBtn) {
      toggleBtn.addEventListener("click", () => {
        ...
        if (entityPanel.innerHTML.trim() !== "") {
          ...
          if (inner) renderEntityTypeTab(serviceId, inner);
        }
      });
    }
  });
