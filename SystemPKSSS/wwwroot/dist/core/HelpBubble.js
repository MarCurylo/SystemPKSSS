...
function normalizeHashToPattern(hash) {
    // Rozděl hash podle #
...
export function showHelpBubble() {
  ...
  `;
    ...
    (_a = document.getElementById("help-bubble-close")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
        if (helpBubble) {
            helpBubble.remove();
            helpBubble = null;
        }
